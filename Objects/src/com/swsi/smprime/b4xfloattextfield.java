...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.swsi.smprime.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.swsi.smprime.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public com.swsi.smprime.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new com.swsi.smprime.b4xfloattextfield();
...
__c.LogImpl("910944536","Multiline not supported with password mode.",0);
 };
...
public com.swsi.smprime.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((com.swsi.smprime.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(com.swsi.smprime.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((com.swsi.smprime.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (com.swsi.smprime.b4xfloattextfield)(_o);
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((com.swsi.smprime.b4xfloattextfield)(this)) == false) { 
