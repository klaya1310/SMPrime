...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.swsi.smprime.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.swsi.smprime.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(com.swsi.smprime.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public com.swsi.smprime.b4xformatter._b4xformatdata  _copyformatdata(com.swsi.smprime.b4xformatter._b4xformatdata _data) throws Exception{
com.swsi.smprime.b4xformatter._b4xformatdata _d = null;
...
_d = new com.swsi.smprime.b4xformatter._b4xformatdata();
...
public com.swsi.smprime.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
com.swsi.smprime.b4xformatter._b4xformatdata _d = null;
...
com.swsi.smprime.b4xformatter._b4xformatdata _data = null;
...
public com.swsi.smprime.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (com.swsi.smprime.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 78;BA.debugLine="End Sub";
return null;
}
public com.swsi.smprime.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
com.swsi.smprime.b4xformatter._b4xformatdata _d = null;
...
_d = (com.swsi.smprime.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public com.swsi.smprime.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
