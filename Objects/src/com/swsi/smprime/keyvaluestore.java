...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.swsi.smprime.keyvaluestore");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.swsi.smprime.keyvaluestore.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_GetMapAsync(com.swsi.smprime.keyvaluestore parent,anywheresoftware.b4a.objects.collections.List _keys) {
this.parent = parent;
this._keys = _keys;
}
com.swsi.smprime.keyvaluestore parent;
...
parent.__c.LogImpl("91048599",BA.ObjectToString(parent.__c.LastException(parent.getActivityBA())),0);
 if (true) break;
...
public ResumableSub_PutMapAsync(com.swsi.smprime.keyvaluestore parent,anywheresoftware.b4a.objects.collections.Map _map) {
this.parent = parent;
this._map = _map;
}
com.swsi.smprime.keyvaluestore parent;
...
parent.__c.LogImpl("91114120","Failed to serialize object: "+BA.ObjectToString(_map.Get((Object)(_key))),0);
 if (true) break;
