...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.swsi.smprime.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.swsi.smprime.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public com.swsi.smprime.b4xdialog _mdialog = null;
...
_mdialog = new com.swsi.smprime.b4xdialog();
...
public String  _show(com.swsi.smprime.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((com.swsi.smprime.b4xdialog) args[0]);
